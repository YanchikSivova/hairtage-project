...
function normalizeProduct(product) {
  return {
    ...
    ingredients:
      ...
      [],
    picUrl: getPublicImagePath(product.picUrl),
  }
}
    ...
    <>
      <header className='admin-top'>
        ...
        <div className='admin-top-right'>
          ...
          <div className='admin-brand-static' aria-label='Hairtage'>
            <span>Hairtage</span>
                ...
                {items.map((product) => (
                  ...
                  >
                    <div className='product-image-wrap'>
                      ...
                      <div className='product-image-placeholder is-hidden'>Нет фото</div>
                    </div>

                    <div className='product-info'>
                      <p className='product-name' title={product.productName}>
                        {product.productName}
                      </p>
                      <p className='price'>
